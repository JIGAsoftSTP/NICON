...
//            PdfPTable pTableSegu1;
            ...
            Font fontCorpoN = FontFactory.getFont(Fontes.FONTB, BaseFont.WINANSI, BaseFont.EMBEDDED, 8.7f);
            Font fontCorpo = FontFactory.getFont(Fontes.FONT, BaseFont.WINANSI, BaseFont.EMBEDDED, 8.7f);
...
//            pTableLinha.addCell(linha);
            ...
            documento.setMargins(20f, 20f, 123f, 5f);
